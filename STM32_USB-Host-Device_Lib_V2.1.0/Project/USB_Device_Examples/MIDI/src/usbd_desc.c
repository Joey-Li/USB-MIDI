...
#define USBD_VID                      0xB483
#define USBD_PID                      0x571F

#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      "ABC Technology Inc."

#define USBD_PRODUCT_HS_STRING        "ABC Txxx Pxxx"
#define USBD_SERIALNUMBER_HS_STRING   "00000000011B"

#define USBD_PRODUCT_FS_STRING        "ABC Txxx Pxxx"
